%PLOTMODELPARAMETERSANDDATA2D plots the parameters of the model in a parallel coordinates plot.
...
%
%  figHand = PlotModelParametersAndData2D(model, posteriorSamples, ...
...
function figHand = PlotModelParametersAndData2D(model, posteriorSamples, data, varargin)
  % Plot data fit
  ...
  PlotModelFit2D(model, params, data, 'PdfColor', colorOfLine(end,:),...
      'SubplotDims',[2 2],'SubplotInds',[2 4]);
